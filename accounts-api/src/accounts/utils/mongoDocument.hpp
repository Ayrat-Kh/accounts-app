...
namespace accounts::utils
{
    ...
    //     {
    //         auto res = std::move(MongoSerializeHelpers<TElement>::deserializeScalar<std::optional<std::string>>(element));
    ...
    //     {
    //         auto res = std::move(MongoSerializeHelpers<TElement>::deserializeScalar<std::optional<double>>(element));
    ...
    //     {
    //         auto res = std::move(MongoSerializeHelpers<TElement>::deserializeScalar<std::optional<std::int64_t>>(element));
    //         return res.has_value() ? res.value() : 0.f;
    //     }
    ...
    //     {
    //         auto res = std::move(MongoSerializeHelpers<TElement>::deserializeScalar<std::optional<std::int32_t>>(element));
    //         return res.has_value() ? res.value() : 0.f;
    //     }

    //     template <>
    //     std::optional<::accounts::shared::Datetime> deserializeScalar(const TElement &element)
    //     {
    ...
    //     }
    //     template <>
    //     ::accounts::shared::Datetime deserializeScalar(const TElement &element)
    //     {
    //         auto res = std::move(MongoSerializeHelpers<TElement>::deserializeScalar<std::optional<::accounts::shared::Datetime>>(element));
    //         return res.has_value() ? res.value() : ::accounts::shared::Datetime{};
    //     }
    ...
    //             std::is_same<TReturn, ::accounts::shared::Datetime>::value ||
    //             std::is_same<TReturn, std::optional<::accounts::shared::Datetime>>::value)
    //         {
    //             return std::move(MongoSerializeHelpers<TElement>::deserializeScalar<TReturn>(element));
    //         }
