...
std::variant<app::auth::UserLoginResult, app::error::AppError> app::auth::AuthServiceImpl::googleAuth(std::string_view idToken)
{
    ...
    app::services::GoogleTokenInfo googleLoginResult = std::get<app::services::GoogleTokenInfo>(googleAuthResult);
    ...
    auto user = std::get<app::users::UserDb>(userDbResult);
