...
export const ExpensesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1ExpensesExpenseIdPut: async (data: ExpensesExpenseUpsertDto, authorization: string, expenseId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        v1ExpensesPost: async (data: ExpensesExpenseUpsertDto, authorization: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'data' is not null or undefined
...
export const ExpensesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1ExpensesExpenseIdPut(data: ExpensesExpenseUpsertDto, authorization: string, expenseId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExpensesExpenseResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1ExpensesExpenseIdPut(data, authorization, expenseId, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async v1ExpensesPost(data: ExpensesExpenseUpsertDto, authorization: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExpensesExpenseResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1ExpensesPost(data, authorization, options);
            const index = configuration?.serverIndex ?? 0;
...
export const ExpensesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        v1ExpensesExpenseIdPut(data: ExpensesExpenseUpsertDto, authorization: string, expenseId: string, options?: any): AxiosPromise<ExpensesExpenseResult> {
            return localVarFp.v1ExpensesExpenseIdPut(data, authorization, expenseId, options).then((request) => request(axios, basePath));
        },
        /**
         * Get expenses for the logged in user
         * @summary Get expenses for the logged in user
         ...
         * @throws {RequiredError}
         */
        v1ExpensesPost(data: ExpensesExpenseUpsertDto, authorization: string, options?: any): AxiosPromise<ExpensesExpenseResult> {
            return localVarFp.v1ExpensesPost(data, authorization, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ExpensesApi extends BaseAPI {
     ...
     * @memberof ExpensesApi
     */
    public v1ExpensesExpenseIdPut(data: ExpensesExpenseUpsertDto, authorization: string, expenseId: string, options?: RawAxiosRequestConfig) {
        return ExpensesApiFp(this.configuration).v1ExpensesExpenseIdPut(data, authorization, expenseId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ExpensesApi
     */
    public v1ExpensesPost(data: ExpensesExpenseUpsertDto, authorization: string, options?: RawAxiosRequestConfig) {
        return ExpensesApiFp(this.configuration).v1ExpensesPost(data, authorization, options).then((request) => request(this.axios, this.basePath));
    }
}
